      ...
      "
          >
            <h1 className="font-urbanist text-[18px] md:text-[35px] font-normal capitalize">
              We handle personal injury cases, helping people who were hurt
              because someone else acted carelessly or failed to keep them safe.
              .
            </h1>
          </div>
        ...
        >
          ...
          <div
            className="
              relative z-10
              w-full
              max-w-[900px] lg:max-w-[980px] xl:max-w-[1040px]
            ...
            "
          >
             <h1 className="font-urbanist text-[50px] font-normal capitalize">
            We handle personal injury cases, helping people who were hurt
            because someone else acted carelessly or failed to keep them safe.{" "}
            </h1>
          </div>
