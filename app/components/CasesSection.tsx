...
<div
  className="
    w-full lg:w-[95%] relative lg:h-[508px] 
    ...
    py-4 md:py-4 lg:pb-[20px] lg:pt-[20px]
    lg:rounded-bl-[18px]  
...
>
        ...
        {/* Header */}
        <div className="flex flex-col lg:items-start items-center mb-8 md:mb-2 lg:pl-10">
          <h1 className="font-noto-serif font-normal text-[30px] md:text-[44px] text-white md:mb-8 text-center lg:text-left leading-[70px] capitalize">
