...
export const trucklawsuitContent: LawsuitContent = {
  realStories: [
    {
      name: "Todd Engel",
      story:
  ...
  healthRisks: [
    ...
    },
    {
      ...
      description:
        "Medical studies have linked Ozempic to an increased risk of gallbladder problems, including gallstones and inflammation requiring surgery.",
    },
    {
      number: "04",
      title: "Pancreatitis",
    ...
    },
    {
      ...
      description:
        "Paralysis or inflammation can cause food to build up in the intestines, sometimes requiring bowel surgery.",
    },
  ],
  ...
  whoQualifies: [
    {
      description:
        "You took Ozempic, Wegovy, Mounjaro, Rybelsus, Saxenda, Trulicity, or Zepbound for weight loss or diabetes.",
    },
    {
      description:
        "You were diagnosed with gastroparesis, intestinal blockage, or experienced chronic vomiting requiring medical care.",
    },
    {
      description:
        "Your symptoms began during or shortly after using the medication.",
    },
    {
      description:
        "You are within your state's statute of limitations to file a claim.",
    },
  ],
  ...
  compensation: [
    {
      ...
      description:
        "Hospital stays, doctor visits, medications, tests, and surgeries.",
    },
    {
      title: "Lost Wages",
      description:
        "Compensation for missed work or reduced earning ability.",
    },
    {
    ...
    },
    {
      ...
      description:
        "Possible additional damages if misconduct is proven.",
    },
  ],
  ...
  pageContent: {
    ...
    mainParagraphs: [
"Ozempic has gained widespread attention as a treatment for type 2 diabetes and for its off-label use in weight loss. However, growing reports of severe gastrointestinal injuries have led many patients to file",
"Ozempic lawsuits against drug manufacturers. If you or a loved one has experienced serious side effects after using Ozempic, Wegovy, or Mounjaro, you may be eligible for compensation. We’re ready to help you take action"

    ],

    allegationsTitle: "What are the Allegations Against Ozempic?",
    allegationsParagraph:
      "Patients allege that Novo Nordisk and other manufacturers failed to properly warn about gastroparesis and other serious complications while aggressively marketing the drug.",
    ...
    healthRisksParagraph:
      "Affected individuals argue that the manufacturer failed to disclose the full risks associated with long-term use.",
    ...
    whoQualifiesParagraph:
      "Many users have developed severe digestive complications after using Ozempic or similar drugs.",
    ...
    compensationParagraph:
      "Patients harmed by Ozempic are pursuing compensation for medical costs, lost income, and suffering.",
    compensationSubtitle: "If eligible, you may be able to recover damages such as:",

    realStoriesTitle: "Real Stories Behind the Lawsuit",

    stepsTitle: "How to File an Ozempic Lawsuit",
    stepsParagraph:
      "Connect2Attorney helps you file your case in three simple steps:",
  },

  ctaContent: {
    title: "Ready to Get Started?",
    description:
      "Don't wait. Get a free, confidential case review today.",
  ...
  steps: [
    {
      ...
      description: "Tell us what happened to you.",
    },
    {
      step: 2,
      title: "Confirm Eligibility",
      description: "Our legal team reviews your case.",
    },
    {
      step: 3,
      title: "File Your Claim",
      description: "We connect you with the right law firm.",
    },
  ],
  ...
  sectionIds: {
    ...
    realStoriesTitle: "real-stories-ozempic",
