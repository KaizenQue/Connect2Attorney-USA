...
<svg xmlns="http://www.w3.org/2000/svg" width="29" height="28" viewBox="0 0 29 28" fill="none">
  <path d="M5.73099 0L9.47369 0.706309L7.7193 13.6554L10.5263 14.7148V27.193H0V15.5388L5.73099 0ZM23.2749 0L27.0175 0.706309L25.2632 13.6554L28.0702 14.7148V27.193H17.5439V15.5388L23.2749 0Z" fill="#DBDFE7"/>
</svg>
));
const RightApos = React.memo(() => (
<svg xmlns="http://www.w3.org/2000/svg" width="29" height="28" viewBox="0 0 29 28" fill="none">
  <path d="M22.3393 27.1934L18.5966 26.4871L20.351 13.538L17.544 12.4785V0.000377655H28.0703V11.6545L22.3393 27.1934ZM4.79546 27.1934L1.05277 26.4871L2.80716 13.538L0.000137329 12.4785V0.000377655H10.5265V11.6545L4.79546 27.1934Z" fill="#DBDFE7"/>
</svg>
));
/* ------------------------------------------------------------------ */
/* TYPES */
        ...
        <div className="relative z-10 w-full h-full px-4 sm:px-8 md:px-12 lg:px-20 py-8 sm:py-12 md:py-16 lg:py-24 flex flex-col lg:flex-row items-center justify-center lg:justify-between gap-6 md:gap-8 lg:gap-0">
          <div className="relative max-w-full lg:max-w-[560px] opacity-0 translate-y-6 animate-[fadeUp_0.6s_ease-out_0.25s_forwards]">
            <div className="flex items-center gap-3 mb-4 sm:mb-6">
              ...
              <p className={`font-work-sans text-sm sm:text-[15.789px] font-semibold uppercase ${isDeputy ? "text-[#F2C438]" : "text-white"}`}>
                {person.role}
              </p>
            </div>

            <h2 className={`flex flex-col justify-center w-full max-w-[432px] min-h-[150px] sm:min-h-[200px] md:min-h-[270px] font-urbanist text-5xl sm:text-7xl md:text-8xl lg:text-[105.8px] leading-none font-extrabold bg-clip-text text-transparent mb-6 md:mb-10 opacity-0 scale-[0.98] animate-[fadeScale_0.55s_ease-out_0.35s_forwards] ${isDeputy ? "bg-[linear-gradient(100deg,#F2C438_37.2%,#FFFFFF_63.99%,rgba(255,255,255,0)_90.04%)]" : "bg-[linear-gradient(95deg,#F2C438_33.32%,#FFFFFF_57.48%,rgba(255,255,255,0)_80.98%)]"}`}>
              <span>{firstName}</span>
              <span>{lastName}</span>
            </h2>
  ...
  return (
    <div className="relative min-h-screen bg-[#162766] font-sans text-white py-10 px-4 flex justify-center overflow-x-hidden">
      <div className="relative w-full max-w-[900px] z-10">
        <div className="relative w-full bg-no-repeat bg-center bg-cover py-20" style={{ backgroundImage: "url('/bgimgfullpartial.png')" }}>
          {activePerson && <DrivingForceHover person={activePerson} onLeave={() => setActivePerson(null)} />}

          <div className="relative z-10 text-center mb-8">
            <h1 className="font-noto-serif font-normal capitalize mb-8" style={{ fontSize: "clamp(32px, 7vw, 60px)", lineHeight: "clamp(40px, 8vw, 70px)" }}>
              <span className="text-[#eec044]">Our</span> Driving Force
            </h1>

            <div className="flex flex-wrap justify-center gap-8 mb-8">
              {leaders.map((leader, index) => (
                <div key={index} onMouseEnter={() => setActivePerson(leader)} className="flex flex-col items-center w-[220px] cursor-pointer">
                  ...
                  <div className="text-center mt-4">
                    <p className="text-[#eec044] uppercase tracking-widest text-[12px] mb-1">{leader.role}</p>
            ...
            <div className="flex justify-center mb-16">
              <div onMouseEnter={() => setActivePerson(deputy)} className="flex flex-col items-center w-[220px] cursor-pointer">
                <div className="relative w-full h-[220px] rounded-[20px] overflow-hidden">
                  <img src={deputy.img} alt={deputy.name} className="w-full h-full object-cover" />
                </div>
                <div className="text-center mt-4">
                  <p className="text-[#eec044] uppercase tracking-widest text-[12px] mb-1">{deputy.role}</p>
        ...
        <div className="relative z-10 text-center">
          <h2 className="font-noto-serif font-normal capitalize mb-8" style={{ fontSize: "clamp(28px, 6vw, 48px)", lineHeight: "clamp(36px, 7vw, 60px)", letterSpacing: "0px" }}>
          ...
          <div className="flex overflow-x-auto snap-x snap-mandatory gap-6 pb-6 px-4 -mx-4 scrollbar-hide md:grid md:grid-cols-3 md:overflow-visible md:pb-0 md:px-0 md:mx-0">
            {teamMembers.map((member, index) => (
              <div key={index} className="group shrink-0 w-[200px] md:w-auto snap-center flex flex-col items-center">
                <div className="relative w-full aspect-square rounded-[20px] overflow-hidden mb-3">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center px-3 text-center bg-transparent group-hover:bg-[#1d3a8a] transition-colors duration-300">
                    <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                      <p className="font-urbanist text-[11px] md:text-xs uppercase tracking-[0.18em] text-white mb-1">{member.role}</p>
                      <h3 className="font-urbanist text-sm md:text-base text-white">{member.name}</h3>
                    </div>
                  </div>
                </div>
                ...
                <h3 className="font-urbanist font-normal group-hover:text-white transition-colors" style={{ fontSize: "18px", lineHeight: "24px", letterSpacing: "0px" }}>
                  {member.name}
                </h3>
              </div>
            ))}
        ...
        <img src="/bgvector.png" alt="background vector" className="absolute top-[-20] right-0 h-full w-auto object-contain object-right lg:translate-x-[12%] xl:translate-x-[15%] z-20 pointer-events-none select-none" />
      </div>
    </div>
  );
};
    ...
    <div className="relative min-h-screen bg-[#162766] font-sans text-white py-10 px-4 flex justify-center overflow-x-hidden">
      <div className="relative w-full max-w-[900px] z-10">
        <div className="relative w-full pt-16 pb-10">
          <div className="relative z-10 text-center">
            <h1 className="font-noto-serif font-normal capitalize mb-10" style={{ fontSize: "clamp(32px, 7vw, 60px)", lineHeight: "clamp(40px, 8vw, 70px)" }}>
              <span className="text-[#eec044]">Our</span> Driving Force
            </h1>

            <div className="grid grid-cols-2 gap-4 mb-10 md:flex md:flex-wrap md:justify-center md:gap-8">
              {mobileleaders.map((leader, index) => (
                <div key={index} className="flex flex-col items-center w-full md:w-[220px]">
                  <Link href={leader.linkedIn} target="_blank" rel="noopener noreferrer" className="relative w-full h-[150px] md:h-[220px] rounded-[16px] md:rounded-[20px] overflow-hidden cursor-pointer">
                    <img src={leader.img} alt={leader.name} className="w-full h-full object-contain" loading="lazy" />
                  </Link>
                  <div className="text-center mt-3 md:mt-4">
                    <p className="text-[#eec044] font-urbanist uppercase tracking-widest text-[10px] md:text-[12px] mb-1">{leader.role}</p>
                    <h3 className="font-urbanist font-normal text-[14px] md:text-[18px]">{leader.name}</h3>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className="relative flex justify-center pt-16 pb-10">
              <div className="absolute inset-x-0 top-0 h-full bg-no-repeat bg-center bg-contain pointer-events-none" style={{ backgroundImage: "url('/bgmobilevector.png')" }} />
              <div className="relative z-10 flex flex-col items-center w-full max-w-[calc(50%-8px)] md:w-[220px] mb-4">
                <Link href={mobiledeputy.linkedIn} target="_blank" rel="noopener noreferrer" className="relative w-full h-[150px] md:h-[220px] rounded-[16px] md:rounded-[20px] overflow-hidden cursor-pointer">
                  <img src={mobiledeputy.img} alt={mobiledeputy.name} className="w-full h-full object-contain" loading="lazy" />
                </Link>
                <div className="text-center mt-4">
                  <p className="text-[#eec044] font-urbanist uppercase tracking-widest text-[10px] md:text-[12px] mb-1">{mobiledeputy.role}</p>
                  <h3 className="font-urbanist font-normal text-[14px] md:text-[18px]">{mobiledeputy.name}</h3>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="relative z-10 text-center mt-[-4]">
          <h2 className="font-noto-serif font-normal capitalize mb-8" style={{ fontSize: "clamp(28px, 6vw, 48px)", lineHeight: "clamp(36px, 7vw, 60px)" }}>
            Our <span className="text-[#eec044]">A</span> Team
          </h2>
          ...
          <div className="flex overflow-x-auto snap-x snap-mandatory gap-4 px-4 -mx-4 pb-6 scrollbar-hide md:grid md:grid-cols-3 md:gap-8 md:overflow-visible md:px-0 md:mx-0">
            {teamMembers.map((member, index) => (
              <div key={index} className="shrink-0 snap-center w-[calc(50%-8px)] md:w-auto flex flex-col items-center">
                <div className="relative w-full h-[150px] md:h-[220px] rounded-[16px] md:rounded-[20px] overflow-hidden">
                  <img src={member.img} alt={member.name} className="w-full h-full object-cover transition-transform duration-300 group-hover:scale-105" />
                </div>
                <div className="text-center mt-3">
                  <p className="text-[#eec044] font-urbanist uppercase tracking-widest text-[10px] md:text-[12px] mb-1">{member.role}</p>
                  <h3 className="font-urbanist font-normal text-[14px] md:text-[18px]">{member.name}</h3>
                </div>
              </div>
            ))}
          </div>
...
const TeamSectionTablet = () => {
  return (
    <div className="relative min-h-screen bg-[#162766] font-sans text-white py-10 px-4 flex justify-center overflow-x-hidden">
      <div className="relative w-full max-w-[900px] z-10">
        <img src="/bgtabletvectorleft.png" alt="background vector" className="absolute top-0 left-0 h-[85%] w-auto max-w-[60%] object-contain object-left md:-translate-x-[1%] md:-translate-y-[15%] lg:translate-x-[12%] xl:translate-x-[15%] z-20 pointer-events-none select-none" />

        <div className="relative w-full bg-no-repeat bg-center bg-cover py-20">
          <div className="relative z-10 text-center mb-8">
            <h1 className="font-noto-serif font-normal capitalize mb-8" style={{ fontSize: "clamp(32px, 7vw, 60px)", lineHeight: "clamp(40px, 8vw, 70px)", letterSpacing: "0px" }}>
              <span className="text-[#eec044]">Our</span> Driving Force
            </h1>
            ...
            <div className="flex flex-wrap justify-center gap-8 mb-8">
              {tabletleaders.map((leader, index) => (
                <div key={index} className="flex flex-col items-center w-[220px]">
                  ...
                  <div className="text-center mt-4">
                    <p className="text-[#eec044] font-urbanist font-normal uppercase tracking-widest mb-1 text-[12px]">{leader.role}</p>
                    <h3 className="font-urbanist font-normal text-[18px]">{leader.name}</h3>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className="flex justify-center mb-16">
              <div className="flex flex-col items-center w-[220px]">
                <div className="relative w-full h-[220px] rounded-[20px] overflow-hidden">
                  <img src={tabletdeputy.img} alt={tabletdeputy.name} className="w-full h-full object-cover" loading="lazy" />
                </div>
                <div className="text-center mt-4">
                  <p className="text-[#eec044] font-urbanist font-normal uppercase tracking-widest mb-1 text-[12px]">{tabletdeputy.role}</p>
                  <h3 className="font-urbanist font-normal text-[18px]">{tabletdeputy.name}</h3>
                </div>
              </div>
            </div>
          </div>
        ...
        <img src="/bgvector.png" alt="background vector" className="absolute top-[-8] right-0 h-full w-auto object-contain object-right lg:translate-x-[12%] xl:translate-x-[15%] z-20 pointer-events-none select-none" />
      </div>
    </div>
  );
};
...
const TeamSection = () => {
  return (
    <>
      <div className="md:hidden"><TeamSectionMobile /></div>
      <div className="hidden md:block lg:hidden"><TeamSectionTablet /></div>
      <div className="hidden lg:block"><TeamSectionDesktop /></div>
    </>
  );
};
